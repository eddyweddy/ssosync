...
![Github Action](https://github.com/eddyweddy/ssosync/workflows/main/badge.svg)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/eddyweddy/ssosync)](https://goreportcard.com/report/github.com/eddyweddy/ssosync)
...
You can `go get github.com/eddyweddy/ssosync` or grab a Release binary from the release page. The binary
...
```bash
git clone https://github.com/eddyweddy/ssosync.git
cd ssosync/
make go-build
```
...
Complete documentation is available at https://github.com/eddyweddy/ssosync
